    ...
    <PolicyContainer>
      <div className="inner-layer">
        ...
        <section className="write-ups">
          <p>
            Smartearners is registered with the Securities and Exchange Commission in Nigeria as a fund/portfolio manager. Smartearners is a financial platform with the intent of giving our community members an opportunity to grow financially. It is a subset of the marketing and community building programme of the Smartearners cryptocurrency token set to be launched on the Binance Smartchain network soon.
          </p>
        </section>
        ...
        <Title level={3}>
          ...
          <section className="write-ups">
            ...
            We offer a savings and staking service. As our client, we will manage your savings and stakings on your behalf in a very low cost manner to maximize your returns (the “Services”), Earners PRO may provide certain other services that may be selected by the Client and as may be agreed by both parties. This Terms of use sets out the terms and conditions under which Smartearners will provide the Services to its Clients. Our website and mobile applications, you enter into a series of legally binding agreements. You also agree to our Privacy Policy which covers how we collect, use, share and store your personal information.
            </p>
          </section>
          ...
          <section className="write-ups">
              <p>
              Smartearners is intended solely for individuals who are 18 or older. Any access to or use of Smartearners by anyone under 18 is unauthorized, unlicensed, and in violation of these Terms of Use. By accessing or using Smartearners, you represent and warrant that you are 18 or older.
              </p>
          </section>
          ...
          <section className="write-ups">
              <p>
              The Client hereby appoints Smartearners as its portfolio manager and grants a limited power-of-attorney with discretionary trading authority to manage and trade the funds in your User Account. Smartearners accepts this appointment under the terms and conditions set forth in this Agreement and the Terms and Conditions set forth on our website, which will change periodically and without your consent.
              </p>
              <h5>You acknowledge that:</h5>
              <ul>
                <li>Smartearners will deliver the Services exclusively through an online platform and/or mobile application (collectively, including any updates and replacement
          ...
          <Title level={3}>
            <p>3.1 Smartearners Staking Plans</p>
            <p></p>
          </Title>
          ...
          <Title level={2}>
            <p>5. Smartearners &quot;Dos&quot; and &quot;Don&apos;ts&quot;</p>
            <p></p>
          </Title>
          <section className="write-ups">
              <p>Smartearners grants you a license to use our website and mobile applications so long as you comply with all our rules.
              </p>
          </section>
                  ...
                  <li>
                    <span>
                        ...
                        <ol>
                          ...
                          <li>Interfere with or disrupt (or attempt to interfere with or disrupt) any Earners PRO web page, server, or network, or the technical delivery systems of Smartearners&apos;s providers, or disobey any requirements, procedures, policies, or regulations of networks connected to Smartearners.</li>
                          <li>Attempt to probe, scan, or test the vulnerability of any Earners PRO system or network or breach or impair or circumvent any security or authentication measures protecting Smartearners;</li>
                          <li>Attempt to decipher, decompile, disassemble, or reverse-engineer any of the software used to provide Earners PRO;</li>
                          <li>Attempt to access, search, or meta-search Smartearners or content thereon with any engine, software, tool, agent, device, or mechanism other than software and/or search agents provided by Smartearners or other generally available third- party web browsers, including without limitation any software that sends queries to Smartearners to determine how a website or web page ranks;</li>
                          <li>Violate the terms of use or any other rule or agreement applicable to you or Smartearners&apos;s inclusion in, reference to, or relationship with any third party or third-party site or service, or your use of any such third-party site or service; Collect or store personal information about other users without their express permission;</li>
                          ...
                          <li>Copy or use the information, content or data on Smartearners in connection with a competitive service (as determined by Smartearners);</li>
                          <li>Monitor Earners PRO&apos;s availability, performance or functionality for any competitive purposes</li>
                          <li>Use Smartearners or content thereon in any manner not permitted by these Terms of Use</li>
                          <li>Copyrighted Materials: No Unauthorized Use. If you become aware of misuse of Smartearners or content thereon by any person, please contact Smartearners to report any abuse. Smartearners has adopted and implemented a policy that provides for the termination of Accounts of users who infringe the rights of copyright holders. Please see the Smartearners Copyright and Intellectual Property
